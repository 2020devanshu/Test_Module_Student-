...
class SequencingSentencing extends StatefulWidget {
  @override
  _SequencingSentencingState createState() => _SequencingSentencingState();
}

class _SequencingSentencingState extends State<SequencingSentencing> {
  int radioValue = 0;
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              ...
                              child: Text(
                                "Rank these minerals by thier hardness on mohs scale. Put the softest at the bottom",
                                style: TextStyle(
                                  fontSize: 12,
                                  decoration: TextDecoration.none,
                                  fontWeight: FontWeight.w400,
