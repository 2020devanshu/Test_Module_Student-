...
class FreeTextAnswer extends StatefulWidget {
  @override
  _FreeTextAnswerState createState() => _FreeTextAnswerState();
}
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                ...
                                "volutpat. Non pharetra urna, id nisl, gravida convallis augue velit lectus."
              ...
              Padding(
                ...
                child: Container(
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Icon(Icons.chat_bubble, size: 26, color: Colors.red),
                      Container(
